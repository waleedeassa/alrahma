...
@push('js')
    ...
    <script>
        ...
        // Orphans Chart by Governorate
        new Chart(document.getElementById('orphansGovChart'), {
            type: 'bar',
            data: {
                labels: {!! json_encode($govLabels, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) !!},
                datasets: [{
                    label: 'عدد الأيتام',
                    data: {!! json_encode($orphansGovCounts, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) !!},
                    backgroundColor: '#296060',
                    borderRadius: 4,
                    barThickness: 25,
                    maxBarThickness: 25,
        ...
        new Chart(document.getElementById('familiesGovChart'), {
            ...
            data: {
                ...
                datasets: [{
                    label: 'عدد الأسر',
                    data: {!! json_encode($familiesGovCounts, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) !!},
                    backgroundColor: '#296060',
                    borderRadius: 4,
                    barThickness: 25,
                    maxBarThickness: 25,
