                                    ...
                                    <div class="container">
                                        <div class="orphan-data">
                                            ...
                                            <div class="line">
                                                ...
                                                @if ($family->housing_ownership == 1)
                                                    <div class="line">
                                                        <label>القيمة الإيجارية</label>
                                                        <input type="text" value="{{ $family->rent_amount }}" readonly>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="line">
                                            ...
                                            <div class="line">
                                                <label>هل يتوفر ماء</label>
                                                <input type="text" value="{{ $family->has_water_label }}" readonly>
                                                <label>هل تتوفر كهرباء</label>
                                                <input type="text" value="{{ $family->has_electricity_label }}" readonly>
                                            </div>
                                            <div class="line">
                                                <label>هل يتوفر صرف صحي</label>
                                                <input type="text" value="{{ $family->has_sewage_label }}" readonly>
                                            </div>
                                            <br>
