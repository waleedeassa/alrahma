...
@section('title', 'بحث المرضى و ذوي الاحتياجات الخاصة')
@section('breadcrumpTitle', 'بحث المرضى و ذوي الاحتياجات الخاصة')
@section('breadcrump')
    @parent
    <li class="breadcrumb-item active">بحث المرضى و ذوي الاحتياجات الخاصة</li>
@endsection
@push('css')
    <style>
