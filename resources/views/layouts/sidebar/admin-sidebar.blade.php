<div class="side-menu-fixed">
  <div class="scrollbar side-menu-bg">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
      ...
      <li>
        <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#support-programs"
          aria-expanded="{{Route::is('admin.support-programs.index') || Route::is('admin.difficult_case_support_programs.create') || Route::is('admin.support-programs.create') ?'true':'false'}}">
          <div class="pull-left"><i class="fa fa-briefcase" style="font-size:16px;"></i><span class="right-nav-text">برامج الدعم</span></div>
          <div class="pull-right"><i class="ti-plus"></i></div>
          <div class="clearfix"></div>
        </a>
        <ul id="support-programs" class="collapse {{Route::is('admin.support-programs.index') || Route::is('admin.difficult_case_support_programs.create') || Route::is('admin.special_needs_people_support_programs.create')?'show':''}}"
          ...
          @endcan
          @can('إضافة دعم الأسر فى وضعية صعبة')
          ...
          @endcan
          @can('إضافة دعم المرضى وذوي الاحتياجات الخاصة')
      ...
      <li>
        <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#families_search"
          aria-expanded="{{ Route::is('admin.families.search.index') || Route::is('admin.difficult-case-families.search.index') || Route::is('admin.special-needs-people.search.index') || Route::is('admin.difficult-case-support-programs.search.index') || Route::is('admin.special_needs_people_support_programs.search.index')  ? 'true' : 'false' }}">
        ...
        <ul id="families_search"
          class="collapse {{ Route::is('admin.families.search.index') || Route::is('admin.difficult-case-families.search.index') || Route::is('admin.special-needs-people.search.index') || Route::is('admin.difficult-case-support-programs.search.index') || Route::is('admin.special_needs_people_support_programs.search.index')   ? 'show' : '' }}"
          data-parent="#sidebarnav">
