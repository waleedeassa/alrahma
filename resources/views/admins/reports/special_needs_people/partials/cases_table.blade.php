...
<div>
  <a href="{{ route('admin.special-needs-people.search.export', $filters) }}" class="button black x-small">
...
<table class="table responsive" id="print2">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a target="_blank" href="{{ route('admin.special-needs-people.show', $case->id) }}">
          {{ $case->id }}
        </a>
      </td>
