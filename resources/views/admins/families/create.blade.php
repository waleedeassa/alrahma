                ...
                <div class="card-body" id="print">
                    ...
                    <form action="{{ route('admin.families.store') }}" class="modal_style" id="myForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-md-3 housing_rent hidden">
                                <x-inputs.text name="rent_amount" label="{{ 'القيمة الإيجارية' }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                            </div>
                            <div class="form-group mb-3 col-md-3">
                            ...
                            <div class="form-group mb-3 col-md-3">
                                ...
                                <select name="has_water">
                                    <option selected disabled>{{ 'اختر من القائمة' }}...</option>
                                    @foreach (config('options.boolean') as $key => $label)
                                        <option value="{{ $key }}" @if (old('has_water') !== null && old('has_water') == $key) selected @endif>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('has_water')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group mb-3 col-md-3">
                                ...
                                <select name="has_electricity">
                                    <option selected disabled>{{ 'اختر من القائمة' }}...</option>
                                    @foreach (config('options.boolean') as $key => $label)
                                        <option value="{{ $key }}" @if (old('has_electricity') !== null && old('has_electricity') == $key) selected @endif>{{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3 col-md-3">
                                ...
                                <select name="has_sewage">
                                    <option selected disabled>{{ 'اختر من القائمة' }}...</option>
                                    @foreach (config('options.boolean') as $key => $label)
                                        <option value="{{ $key }}" @if (old('has_sewage') !== null && old('has_sewage') == $key) selected @endif>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('has_sewage')
                                    <span class="text-danger">{{ $message }}</span>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setupConditionalVisibility('housing_ownership', 'housing_rent');
        });
    </script>
    {{-- validate Inputs --}}
