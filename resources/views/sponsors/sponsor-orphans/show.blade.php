...
@section('breadcrump')
    @parent
    <li class="breadcrumb-item "><a href="{{ route('sponsor.sponsored-orphans') }}" class="default-color">الأيتام المكفولين</a></li>
                                                ...
                                                <tbody>
                                                    @foreach ($orphan->attachments as $attachment)
                                                        <tr style='text-align:center;vertical-align:middle'>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-dark btn-sm" href="{{ route('sponsor.view_orphan_attachment', $attachment) }}" target="_blank" role="button">
                                                                    <i class="fa fa-eye"></i> {{ 'عرض' }}
                                                                </a>

                                                                <a class="btn btn-success btn-sm" href="{{ route('sponsor.download_orphan_attachment', $attachment) }}" role="button">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="{{ route('sponsor.delete_orphan_attachment', $attachment) }}" method="post">
                                                                            @csrf
