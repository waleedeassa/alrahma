...
@section('content')
    <div class="row">
        <div class="col-xl-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('sponsor.profile.update') }}" id="myForm" class="modal_style" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row row-align-end ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <x-inputs.text name="address" label="عنوان الاقامة" :value="$user->address" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
