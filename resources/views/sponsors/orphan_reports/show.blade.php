                        ...
                        <div class="main">
                            <div class="container">
                                <div class="orphan-data">
                                    ...
                                    <h5 style="margin-top: 10px"> البيانات الأساسية والصحية : Informations de base et santé </h5>
                                    <div class="line">
                                    ...
                                    {{-- // add top margin --}}
                                    <h5 style="margin-top: 10px" style="margin-top: 10px" > البيانات التعليمية : Éducation </h5>
                                    <div class="line">
                                    ...
                                    <h5 style="margin-top: 10px"> الجوانب الشخصية والمعيشية : Aspects personnels et vie </h5>
                                    <div class="line">
                                        <label>الشخصية</label>
                                    ...
                                    @if ($orphanReport->supervisor_notes || $orphanReport->orphan_message)
                                        <h5 style="margin-top: 10px">الملاحظات : Notes</h5>
                                        @if ($orphanReport->supervisor_notes)
                                            <div class="notes-section">
                                                <label>ملاحظات المشرف</label>
                                                <div class="report-text">{!! nl2br(e($orphanReport->supervisor_notes)) !!}</div>
                                            </div>
                                        @endif

                                        @if ($orphanReport->orphan_message)
                                            <div class="notes-section">
                                                <label>رسالة اليتيم</label>
                                                <div class="report-text">{!! nl2br(e($orphanReport->orphan_message)) !!}</div>
                                            </div>
                                        @endif
                                    @endif
                                </div>
