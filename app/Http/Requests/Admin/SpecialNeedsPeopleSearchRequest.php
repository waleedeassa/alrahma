...
class SpecialNeedsPeopleSearchRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'special_needs_type' => [
        'nullable',
        Rule::in(array_keys(config('options.special_needs_type')))
      ],
      'social_status' => [
        'nullable',
  ...
  public function messages(): array
  {
    return [
      ...
      'special_needs_type.in'     => 'نوع الاحتياج الخاص المختار غير صحيح.',
