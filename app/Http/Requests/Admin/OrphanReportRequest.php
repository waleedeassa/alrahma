...
class OrphanReportRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    $rules = [
      ...
      'orphan_message'                            => 'nullable|string|max:1000',
  ...
  public function messages()
  {
    return [
      ...
      'supervisor_notes.max' => 'قيمة الحقل يجب أن لا تتجاوز حجمه 1000 حرف',
      'orphan_message.string' => 'قيمة الحقل غير صحيحه',
      'orphan_message.max' => 'قيمة الحقل يجب أن لا تتجاوز حجمه 1000 حرف',
