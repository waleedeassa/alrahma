...
@section('title','بحث الأسر فى وضعية صعبة')
@section('breadcrumpTitle','بحث الأسر فى وضعية صعبة')
@section('breadcrump')
@parent
<li class="breadcrumb-item active">بحث الأسر فى وضعية صعبة</li>
@endsection
@push('css')
<style>
...
<div class="row">
  <div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
      <div class="card-body">
        <form action="{{ route('admin.difficult-case-families.search') }}" method="POST" id="searchForm" role="search" autocomplete="off" class="modal_style">
          @csrf
          <div class="row">
            ...
            <div class="form-group mb-3 col-md-3">
              <label class="form-label" for="exampleFormControlSelect1">فئة الحالة</label>
              <select name="difficult_case_type">
                <option selected disabled>{{ 'اختر من القائمة' }}...</option>
...
<script>
  function resetForm() {
    ...
    $('#searchForm').on('submit', function(e) {
        ...
        $.ajax({
          url: "{{ route('admin.difficult-case-families.search') }}",
          method: "POST",
          data: formData, 
