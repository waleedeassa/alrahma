...
@can('حذف أسرة')
@if($orphansCount == 0 )
<a data-bs-toggle="modal" data-bs-target="#delete_family{{ $family->id }}" class="btn btn-lg rounded-pill waves-effect waves-light" title="حذف">
  <i class="fa fa-trash"></i>
</a>
@else
<a class="btn btn-lg rounded-pill" title="لا يمكن حذف أسرة لها أيتام" data-bs-toggle="tooltip" data-bs-placement="top">
