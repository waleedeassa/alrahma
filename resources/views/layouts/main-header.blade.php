      ...
      <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                @elseIf(Auth::guard('sponsor')->check())
                    <a class="dropdown-item" href="{{ route('sponsor.profile') }}"><i class="text-warning ti-user"></i>الملف الشخصى</a>
                    <a class="dropdown-item" href="{{ route('sponsor.password') }}"><i class="text-dark ti-layers-alt"></i>تغيير كلمة المرور </a>
                    <a href="{{ route('sponsor.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="dropdown-item"> <i class="text-danger ti-unlock"></i>تسجيل الخروج</a>
