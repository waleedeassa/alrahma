                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.orphan-report.update', $orphanReport->id) }}" id="myForm" method="POST" class="modal_style" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-md-3">
                                <x-inputs.text name="first_term_average" label="المعدل الدراسي (الدورة الأولى)" inputmode="decimal" pattern="[0-9,]+" placeholder="مثال: 7,50" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" :value="$orphanReport->first_term_average" />
                            </div>
                            <div class="form-group mb-3 col-md-3">
                                <x-inputs.text name="second_term_average" label="المعدل الدراسي (الدورة الثانية)" inputmode="decimal" pattern="[0-9,]+" placeholder="مثال: 8,25" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" :value="$orphanReport->second_term_average" />
                            </div>
                            <div class="form-group mb-3 col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-md-3">
                                ...
                                <select name="like_to_become" class="form-control select2">
                                    <option selected disabled>{{ 'اختر من القائمة' }}...</option>
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-md-12">
                                <label class="form-label">إضافة مرفقات جديدة <span style="color: red"> [ الصيغ المقبولة: JPG, PNG, JPEG, PDF — الحد الأقصى لكل ملف 2MB. ] </span></label>
                    ...
                    @include('admins.orphan_reports.partials.attachments-table', ['orphanReport' => $orphanReport])
                </div>
            </div>
        </div>
    </div>
