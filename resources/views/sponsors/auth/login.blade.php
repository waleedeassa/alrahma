...
@section('form')
<form method="POST" action="{{ route('sponsor.check') }}" id="myForm" class="modal_style"  autocomplete="off">
  @csrf
  ...
  <p style="color: #000; text-align: center; margin-bottom: 10px; margin-top: 15px; font-size: 15px">
    <a href="{{ route('sponsor.forget.password.form') }}">هل نسيت كلمة المرور ؟</a>
  </p>
</form>
@endsection
