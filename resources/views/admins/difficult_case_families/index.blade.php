...
<script>
  $('#yajra_table').DataTable({
    ...
    columns: [
      ...
      {data: 'difficult_case_type_label', name: 'difficult_case_type_label', searchable: false, orderable: false}, // سنقوم بإنشاء هذا
      {data: 'social_status_label', name: 'social_status_label', searchable: false, orderable: false}, // وهذا أيضاً
    ...
    $(document).ready(function() {
        $(document).on('click', '.show-history-btn', function() {
            ...
            // 2. get history data
            var url = "{{ route('admin.difficult_case_support_programs.history', ':id') }}";
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        $.each(response, function(index, item) {
                            ...
                            var deleteUrl = "{{ route('admin.difficult_case_support_programs.destroy', ':id') }}";
