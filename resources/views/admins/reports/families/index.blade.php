...
@section('title','بحث أسر الأيتام')
@section('breadcrumpTitle','بحث أسر الأيتام')
@section('breadcrump')
@parent
<li class="breadcrumb-item active">بحث أسر الأيتام</li>
@endsection
@push('css')
<style>
...
<div class="row">
  <div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
      <div class="card-body">
        <form action="{{ route('admin.families.search') }}" method="POST" id="searchForm" role="search" autocomplete="off" class="modal_style">
          @csrf
          <div class="row">
            ...
            <div class="form-group mb-3 col-md-3">
              <label class="form-label" for="exampleFormControlSelect1"> الجماعة / المدينة </label>
              <select name="city_id">
            ...
            <div class="form-group mb-3 col-md-3">
              <label class="form-label" for="exampleFormControlSelect1"> المؤهل المهنى </label>
              <select name="mother_qualifications" id="mother_qualifications">
                <option selected disabled>{{ 'اختر من القائمة' }}...</option>
            ...
            <div class="form-group mb-3 col-md-3">
              ...
              <select name="mother_education_level" id="mother_education_level">
                <option selected disabled>{{ 'اختر من القائمة' }}...</option>
...
<script>
  function resetForm() {
    ...
    $('#searchForm').on('submit', function(e) {
        ...
        $.ajax({
          url: "{{ route('admin.families.search') }}",
          method: "POST",
          data: formData, 
