...
POTENZA.datatables = function () {
  if ($('#datatable').exists()) {
      if (typeof currentLang !== 'undefined' && currentLang === 'en') {
          loadScript(plugin_path + 'bootstrap-datatables/jquery.dataTables-e.min.js', function() {
              loadScript(plugin_path + 'bootstrap-datatables/dataTables.bootstrap4-e.min.js', function() {
                  $('#datatable').DataTable();
              });
          });
      } else {
